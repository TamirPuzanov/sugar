...
def resnet18_bb(**kwargs: Any) -> ResNet_bb:
    model = ResNet_bb([2, 2, 2, 2], _BasicBlock, **kwargs)

    return model


def resnet34_bb(**kwargs: Any) -> ResNet_bb:
    model = ResNet_bb([3, 4, 6, 3], _BasicBlock, **kwargs)

    return model


def resnet50_bb(**kwargs: Any) -> ResNet_bb:
    model = ResNet_bb([3, 4, 6, 3], _Bottleneck, **kwargs)

    return model


def resnet101_bb(**kwargs: Any) -> ResNet_bb:
    model = ResNet_bb([3, 4, 23, 3], _Bottleneck, **kwargs)

    return model


def resnet152_bb(**kwargs: Any) -> ResNet_bb:
    model = ResNet_bb([3, 8, 36, 3], _Bottleneck, **kwargs)
